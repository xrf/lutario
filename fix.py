...
s = re.sub(r"for \(auto &&l(\w) : basis_1\.channels\(\)\)",
           r"FOR_CHANNEL_1(\1) /* TODO: remove me */", s)
s = re.sub(r"for \(auto &&l(\w)(\w) : basis_2\.channels\(\)\)",
           r"FOR_CHANNEL_2(\1, \2) /* TODO: remove me */", s)

s = re.sub(r"for \(auto &&u(\w) : basis_1.subindices\(l(\w)\)\)",
           r"FOR_STATE_1(\1) /* l\1 <- l\2 */", s)
s = re.sub(r"for \(auto &&u(\w)(\w) : basis_1.subindices\(l(\w)(\w)\)\)",
           r"FOR_STATE_2(\1, \2) /* l\1\2 <- l\3\4 */", s)
